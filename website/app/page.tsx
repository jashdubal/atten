...
const features = [
  { icon: Shield, number: "01", title: "Private by design", copy: "Your text and audio never leave your Mac. No account, API key, or telemetry." },
